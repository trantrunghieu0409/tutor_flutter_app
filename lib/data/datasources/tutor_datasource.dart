...
import 'package:tutor_flutter_app/domain/entities/category.dart';
  ...
  Tutor(
    ...
    sessions: [
      Session(
          ...
          to: const TimeOfDay(hour: 8, minute: 25)),
      Session(
          from: const TimeOfDay(hour: 9, minute: 15),
          to: const TimeOfDay(hour: 10, minute: 30)),
      Session(
          from: const TimeOfDay(hour: 11, minute: 0),
          to: const TimeOfDay(hour: 11, minute: 25)),
      Session(
          from: const TimeOfDay(hour: 13, minute: 0),
          to: const TimeOfDay(hour: 13, minute: 25)),
    ],
  ),
  Tutor(
    name: 'April Baldo',
